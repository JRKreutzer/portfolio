    ...
    return (
        <section id='contact' className="contact section">
            ...
            <div className="contact__container container grid">
                        ...
                        
                        {
                            contact.map((item, i) => (
                                <div className='contact__card' key={i}>
                                    ...
                                    <a href={item.ref} target='_blank' rel='noreferrer' className="contact__button">
                                        {item.text}
                ...
                <div className="contact__content">
                    <h3 className="contact__title">Me mande uma mensage de trabalho</h3>
                    <form ref={form} onSubmit={sendEmail} className="contact__form">
                        ...
                        <div className="contact__form-div contact__form-area">
                            <label className="contact__form-tag">Trabalho</label>
                            <textarea
                                required
                                name="work" 
                                cols="30" rows="10"
                                className='contact__form-input'
                                placeholder='Escreva sobre o trabalho'
                            ></textarea>
                        </div>
                        <div className="form-button">
                            ...
                            {sucess && alert("Mensagem enviada com sucesso!")}
